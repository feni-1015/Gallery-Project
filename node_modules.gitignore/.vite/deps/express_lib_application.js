...
//#endregion
//#region browser-external:querystring
var require_browser_external_querystring = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "querystring" has been externalized for browser compatibility. Cannot access "querystring.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var qs = require_lib();
	var querystring = require_browser_external_querystring();
	/**
...
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function compile(path, options = {}) {
		...
		const fn = tokensToFunction((path instanceof TokenData ? path : parse(path, options)).tokens, delimiter, encode);
	...
	*/
	...
	function pathToRegexp(path, options = {}) {
		...
		const items = (Array.isArray(path) ? path : [path]).map((path) => path instanceof TokenData ? path : parse(path, options));
	...
	*/
	function stringify(data) {
		return data.tokens.map(function stringifyToken(token, index, tokens) {
			...
			const key = isNameSafe(token.name) && isNextNameSafe(tokens[index + 1]) ? token.name : JSON.stringify(token.name);
